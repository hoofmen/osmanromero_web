...
export const bioEntries: BioEntry[] = [
  ...
  },
  {
    ...
    title: 'Education',
    content: '<ul style="list-style:none;padding:0;margin:0"><li style="overflow:hidden;margin-bottom:12px"><img src="/UCN.png" alt="UCN" style="float:left;width:64px;height:64px;object-fit:cover;border-radius:4px;margin-right:10px;margin-bottom:4px" /><strong>Bachelor\'s in Computer Engineering</strong> — <em>Universidad Católica del Norte, Antofagasta.</em> I was good at videogames growing up, so naturally I assumed I could be a software engineer. Back then we just called it "programmer" and nobody took us seriously.</li><li style="overflow:hidden"><img src="/UDD.png" alt="UDD" style="float:left;width:64px;height:64px;object-fit:cover;border-radius:4px;margin-right:10px;margin-bottom:4px" /><strong>Master\'s in Industrial Engineering</strong> — <em>Universidad del Desarrollo, Santiago.</em> Had my doubts about software engineering being a <em>real</em> engineering, so I did this to prove something to myself. All I proved was that I enjoy suffering. 1.5 years I\'ll never get back.</li></ul>',
  },
  {
    id: 'target-contact',
    title: 'Contact',
